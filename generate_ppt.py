...
def create_presentation():
    ...
    # Large Decorative Glowing shape in center-right
    glow = slide.shapes.add_shape(MSO_SHAPE.OVAL, Inches(8), Inches(1), Inches(4.5), Inches(4.5))
    glow.fill.solid()
    glow.fill.fore_color.rgb = RGBColor(16, 28, 54)
    glow.line.color.rgb = PURPLE_ACCENT
    glow.line.width = Pt(1.5)
    
    # Inner glow text or accent
    g_txt = slide.shapes.add_textbox(Inches(8.2), Inches(2.2), Inches(4.1), Inches(2))
    ...
    # Title and Subtitle Text Box on Left
    ...
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "System Architecture & Technologies")
    
    # 4 Cards for horizontal layers
    layers = [
    ...
    # Right Column: Data Dictionary (Users, Files, Folders, Logs)
    ...
    # ==================== SLIDE 5: WORKFLOW: SECURE UPLOAD & OBFUSCATION ====================
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "Workflow: Secure Upload & Storage Obfuscation")
    
    # 5 Steps horizontal boxes
    steps = [
    ...
    # ==================== SLIDE 6: NLP CLASSIFICATION ENGINE ====================
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "NLP-Lexical Document Classification")
    
    # Left Column: Classifier Rules
    add_glass_card(slide, Inches(0.8), Inches(1.5), Inches(5.6), Inches(5.2))
    ...
    # Right Column: Code Snippet representation
    add_glass_card(slide, Inches(6.8), Inches(1.5), Inches(5.6), Inches(5.2))
    ...
    cp_code.font.color.rgb = RGBColor(186, 230, 253) # Light blue code color
    cp_code.space_before = Pt(10)

    # ==================== SLIDE 7: ANONYMOUS DROP FOLDERS ====================
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "Anonymous Coursework Drop Folders")
    
    # Left Block: Faculty setup
    ...
    # ==================== SLIDE 8: REST API ENDPOINT REFERENCE ====================
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "REST API Endpoints & Access Control")
    
    # Let's use 3 cards representing the routers
    routers = [
    ...
    # ==================== SLIDE 10: UI/UX DESIGN SYSTEM ====================
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "UI/UX Design System & Aesthetics")
    
    # 3 columns for visual features
    features = [
    ...
    # ==================== SLIDE 11: INSTALLATION & CONFIGURATION ====================
    slide = prs.slides.add_slide(slide_layout)
    apply_bg(slide)
    add_title(slide, "Installation & Configuration Blueprint")
    
    # Left Block: Environment Configurations (.env)
    add_glass_card(slide, Inches(0.8), Inches(1.5), Inches(5.6), Inches(5.2))
    ...
    # Right Block: Setup & Run Commands
    add_glass_card(slide, Inches(6.8), Inches(1.5), Inches(5.6), Inches(5.2))
